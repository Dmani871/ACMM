...
def export_as_csv(self, request, queryset):
    ...
    for obj in queryset:
        ...
        if isinstance(obj, MenteeProfile):
            ...
            qualifications = [
                (q.name, q.education_level)
                for q in MentorQualification.objects.filter(profile=obj)
            ]
...
class MentorAdmin(admin.ModelAdmin):
    inlines = [MentorQualificationInline, MenteeInline]
    list_filter = [
        "occupation",
        "date_joined",
        "is_active",
    ...
    fieldsets = [
        ...
        (
            "Meta",
            {"fields": ["date_joined", "hear_about_us", "is_active", "tcs_check"]},
        ),
    ]
...
class MenteeAdmin(admin.ModelAdmin):
    ...
    def assign_mentor(self, request, queryset):
        ...
        available_mentors = MentorProfile.objects.filter(
            is_active=True, menteeprofile__isnull=True
        )
