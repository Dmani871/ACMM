# Generated by Django 4.0.4 on 2025-04-05 23:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', django_cryptography.fields.encrypt(models.CharField(max_length=130))),
                ('contact_consent', django_cryptography.fields.encrypt(models.CharField(choices=[('Y', 'Yes'), ('N', 'No')], default='N', max_length=1))),
                ('year_applied', models.CharField(choices=[('A2', 'A level/IB'), ('GRAD', 'Graduate'), ('OTHER', 'Other')], max_length=10)),
                ('date_joined', models.DateTimeField(default=django.utils.timezone.now)),
                ('hear_about_us', models.CharField(choices=[('WM', 'Word of mouth'), ('C', 'Contact from ACMM team'), ('SM', 'Social Media'), ('SU', 'School/University'), ('E', 'Employer')], default=None, max_length=10)),
                ...
                ('wp_scheme', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], default=False)),
                ('applied_before', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], default=False)),
                ...
                ('commitment', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], default=False)),
                ('state_educated', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], default=False)),
                ('family_support', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')], default=False)),
            ],
            options={
                'abstract': False,
            },
