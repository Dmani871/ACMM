...
def next_year_view(request):
    return render(
        request, "mentorship/next_year.html", {"page_title": "Apply Next Year"}
    )
...
def applications_view(request):
    return render(
        request,
        "mentorship/applications.html",
        {"page_title": "ACMM Application Portal"},
    )
...
def mentee_signup_view(request):
    ...
    return render(
        request,
        "mentorship/mentee_signup.html",
        {
            "page_title": "Mentee Application",
            "form": form,
            "qualification_formset": formset,
        },
    )
