...
class CommonProfileInfo(models.Model):
    ...
    number = encrypt(models.CharField(max_length=130))
    contact_consent = encrypt(
        models.CharField(max_length=1, choices=CONSENT_CHOICES, default="N")
    )
